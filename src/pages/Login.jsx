...
const Login = () => {
    ...
    const handleLogin = async (e) => {
        ...
        // Developer Bypass: Allow login with admin/beacon2026 if Supabase users aren't setup yet
        if (email === 'admin@beaconbites.com' && password === 'beacon2026') {
                    ...
                    <div className="form-group" style={{ marginBottom: '20px' }}>
                        ...
                        <div style={{ position: 'relative' }}>
                            ...
                            <input
                                ...
                                placeholder="admin@beaconbites.com"
